...
[View the ScalaDocs](https://github.paypal.com/pages/Paypal-Commons-R/stingray-common/api/0.10.1/index.html#com.paypal.stingray.package)
...
For example,
    ...
    "com.paypal.stingray" %% "stingray-akka" % "0.10.1"
