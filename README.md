...
[View the ScalaDocs](https://paypal.github.io/Cascade/api/0.13.1-SNAPSHOT/index.html#com.paypal.cascade.package)
...
```scala
"com.paypal.cascade" %% "cascade-$projectName" % "0.13.1-SNAPSHOT"
```

For example, to use the Akka library:

```scala
"com.paypal.cascade" %% "cascade-akka" % "0.13.1-SNAPSHOT"
```
