...
[View the ScalaDocs](https://paypal.github.io/Cascade/api/0.1.5/index.html#com.paypal.cascade.package)
...
```scala
"com.paypal" %% "cascade-$projectName" % "0.1.5"
```

For example, to use the Akka library:

```scala
"com.paypal" %% "cascade-akka" % "0.1.5"
```
