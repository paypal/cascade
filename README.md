...
[View the ScalaDocs](https://github.paypal.com/pages/Paypal-Commons-R/stingray-common/api/0.11.0/index.html#com.paypal.stingray.package)
...
For example,
    ...
    "com.paypal.stingray" %% "stingray-akka" % "0.11.0"
