...
```scala
"com.paypal" %% "cascade-$projectName" % "0.4.3"
```

For example, to use the Akka library:

```scala
"com.paypal" %% "cascade-akka" % "0.4.3"
```
...
[View the ScalaDocs](https://paypal.github.io/cascade/api/0.4.3/index.html#com.paypal.cascade.package)
