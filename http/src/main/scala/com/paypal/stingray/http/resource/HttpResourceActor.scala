...
object HttpResourceActor {
   ...
   * @param reqContext the [[com.paypal.stingray.http.resource.HttpResourceActor.ResourceContext]] to pass to
   *                   the [[com.paypal.stingray.http.resource.HttpResourceActor]]
